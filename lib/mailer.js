...
const FROM = process.env.RESEND_FROM || 'about编辑部 <onboarding@resend.dev>';
...
<div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:560px;margin:0 auto;color:#2d2d2d;line-height:1.8;">
  ...
  <p style="font-size:15px;">
    恭喜！您投递的「<strong>${escHtml(jobTitle)}</strong>」项目已通过审核。
  </p>

  <p style="font-size:15px;">
    我们将在近期与您联系，进一步确认合作细节，请保持联系畅通。<br>
    期待与您合作。
  </p>
...
<div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:560px;margin:0 auto;color:#2d2d2d;line-height:1.8;">
  ...
  <p style="font-size:15px;">
    感谢您投递「<strong>${escHtml(jobTitle)}</strong>」项目。以及您为此付出的时间与心思。
  </p>
  ...
  <p style="font-size:15px;">
    我们会持续发布新的项目需求，欢迎您关注并在合适的时候再次投递。<br>
    谢谢您对about编辑部的关注。
  </p>
...
<div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:480px;margin:0 auto;color:#2d2d2d;line-height:1.8;">
  ...
  <p style="font-size:15px;">您正在登录「about编辑部 项目合作招募平台」，验证码为：</p>
